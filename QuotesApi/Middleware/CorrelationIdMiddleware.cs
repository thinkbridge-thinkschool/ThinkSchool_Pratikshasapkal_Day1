...
public sealed class CorrelationIdMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        // BeginScope attaches TraceId to every log message emitted during this
        // request via AsyncLocal, so all log lines from any logger include it.
        using (_logger.BeginScope(new Dictionary<string, object> { ["TraceId"] = correlationId }))
        {
